...
public class Meteor : MonoBehaviour
{
    ...
    void FallDown()
    {
        ...
        float sideSpeed = Random.Range(-2f, 2f);
        rb.linearVelocity = new Vector2(sideSpeed, rb.linearVelocity.y);

        rb.gravityScale = 1f;
        rb.AddTorque(Random.Range(-60f, 60f));
    }
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if(other.tag.Equals("ground"))
        {
            ...
            rb.AddTorque(-rb.angularVelocity * 5f);
        }
    }
